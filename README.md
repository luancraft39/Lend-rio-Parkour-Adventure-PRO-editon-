...
// ⚠️ PASSO IMPORTANTE: Quando você criar o servidor no Glitch.com, 
// coloque o link dele aqui embaixo no lugar de 'http://localhost:3000'!
...
function update() {
    ...
    // Avisa o Servidor que você andou
...
function draw() {
    ...
    // Desenha outros jogadores do mundo
